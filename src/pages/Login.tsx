    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container flex items-center justify-center py-8 md:py-16">
        <div className="max-w-md w-full bg-card border rounded-lg p-8 text-center">
          <div className="h-16 w-16 bg-[#1b2838] rounded-full flex items-center justify-center mx-auto mb-6">
            <LogIn className="h-8 w-8 text-white" />
          </div>
          
          <h1 className="text-2xl font-bold mb-2">Login with Steam</h1>
          <p className="text-muted-foreground mb-8">
            Connect your Steam account to start trading on SkinVault
          </p>
          
          <Button className="w-full bg-[#1b2838] hover:bg-[#2a3f5a] border border-[#2a3f5a] gap-2">
